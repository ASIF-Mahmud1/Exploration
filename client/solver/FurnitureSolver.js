...
import { optimize } from './api-solver'
...
class FurnitureSolver extends Component {
  state = {
    constrain_wood: 0,
    constrain_labor: 0,
    constrain_storage: 0,
  ...
  let   furniture = {
      ...
      "variables": {
          "table": {"wood": this.state.table_wood, "labor": this.state.table_labor, "profit": this.state.table_profit, "table": 2, "storage": 30},   // {"wood": 30, "labor": 5, "profit": 1200, "table": 1, "storage": 30}
          "dresser": {"wood": this.state.dresser_wood, "labor": this.state.dresser_labor, "profit": this.state.dresser_profit, "dresser": 10, "storage": 50} //  {"wood": 20, "labor": 10, "profit": 1600, "dresser": 1, "storage": 50}
      },
...
FurnitureSolver.propTypes = {
  classes: PropTypes.object.isRequired
}

export default withStyles(styles)(FurnitureSolver)
